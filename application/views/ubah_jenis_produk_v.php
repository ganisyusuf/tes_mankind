          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">Form Ubah Jenis Produk</h4>
                <form action="<?php echo site_url(); ?>/Login/update_jenis" method=post>
                    <?php 
                      foreach ($jenis->result() as $i) {
                    ?>
                    <p>Jenis Produk :</p>
                    <input type="text" name="nama_jenis" value="<?php echo $i->nama_jenis ?>" size="50" ><br /><br />
                <!--     <p>Kode Jenis   :</p> -->
                    <input type="hidden" name="kode_jenis" size="50" value="<?php echo $i->kode_jenis ?>" readonly>
                    <input type="submit" value="Simpan" button type="button" class="btn btn-primary">
                    <a href="<?php echo site_url(); ?>/Login" button type="button" class="btn btn-default batal">Batal</a>
                    <?php
                     }
                      ?>
                </form>
