              ...
              <div class="card-header">
                <h4 class="card-title">Form Tambah Produk Baru</h4>
                  ...
                  <form action="<?php echo site_url(); ?>/Produk/tambah_produk" method=post>
                    ...
                    <br /><br />
                    <!-- <p>Jenis Produk :</p>
                    <input type="text" name="kode_jenis" size="50" required><br /><br /> -->
                    <p>Type Produk   :</p>
                    <input type="text" name="type_produk" size="50" required><br /><br /> 
                    <p>Kode Produk   :</p>
                    <input type="text" name="kode_produk" size="50" required><br /><br /> 
                    <p>Nama Produk   :</p>
                    <input type="text" name="nama_produk" size="50" required><br /><br /> 
                    <p>Stok          :</p>
                    <input type="text" name="stok" size="50" required><br /><br /> 
                    <p>Harga         :</p>
                    <input type="text" name="harga" size="50" required><br /><br /> 
                  ...
                  <table class="table tablesorter " id="">
                    ...
                    <tbody>
                      <?php 
                          ...
                          <td class="text-center"><a href="<?php echo site_url(); ?>/Produk/ubah_produk/<?php echo $i->kode_produk;?>" button type="button" class="btn btn-default">Ubah</a>

                          <a href="<?php echo site_url(); ?>/Produk/hapus_produk/<?php echo $i->kode_produk;?>" button type="button" class="btn btn-danger">Hapus</a></td>
                          </td>
                        </tr>
                        <?php
                          }
