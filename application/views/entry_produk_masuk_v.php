          ...
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-header">
                <h4 class="card-title">Form Entry Produk Masuk ke Gudang</h4>
                <p>Nama Produk</p>
                <form action="<?php echo site_url(); ?>/Transaksi_masuk/tambah_masuk" method=post>

                <?php $data = $this->Transaksi_masuk_m->ambilDataProduk(); ?>
