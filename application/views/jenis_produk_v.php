          ...
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-header">
                <h4 class="card-title">Form Tambah Jenis Produk</h4>
                <form action="<?php echo site_url(); ?>/Login/tambah_jenis" method=post>
                    <p>Jenis Produk :</p>
                    <input type="text" name="nama_jenis" size="50" required><br /><br />
                    <p>Kode Jenis   :</p>
      ...
      <!-- <div class="content">
        <div class="row"> -->
          <div class="col-md-12">
            <div class="card ">
              <div class="card-header">
                <h4 class="card-title">List Jenis Produk</h4>
              </div>
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table tablesorter " id="">
                    ...
                    <tbody>
                      <?php 
                          $no=1;
                            foreach ($jenis->result() as $i) {
                          ?>
                          <td><?php echo $no++ ?></td>
                          <td><?php echo $i->kode_jenis ?></td>
                          <td><?php echo $i->nama_jenis?></td>
                          <td class="text-center"><a href="<?php echo site_url(); ?>/Login/ubah_jenis/<?php echo $i->kode_jenis;?>" button type="button" class="btn btn-default">Ubah</a>

                          <a href="<?php echo site_url(); ?>/Login/hapus_jenis/<?php echo $i->kode_jenis;?>" button type="button" class="btn btn-danger">Hapus</a></td>
                          </td>
                        </tr>
                        <?php
                          }
